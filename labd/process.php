...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    <head>
        ...
        <style>
            body { font-family: papyrus, sans-serif; background-color: #b3d1dd; padding: 20px; }
            .container { background: white; padding: 20px; border-radius: 5px; width: 500px; margin: auto;
                         box-shadow: 0 0 30px rgba(31, 4, 61, 0.7); display: flex; flex-direction: column; gap: 10px; }
            .button-group { display: flex; justify-content: flex-end; gap: 10px; margin-top: 20px; }
            .button { background-color: #12af75; color: white; padding: 10px 15px; border: none; cursor: pointer; border-radius: 4px; }
            .button.cancel { background-color: #888; }
        </style>
        <script>
